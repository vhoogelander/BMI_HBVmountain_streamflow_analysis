...
function setup(Discharge=0.0, Total_Evaporation=0.0, Snow_Extend=zeros(1), bare_storage=Storages(0, zeros(1), zeros(1), zeros(1), 0), forest_storage=Storages(0, zeros(1), zeros(1), zeros(1), 0), 
