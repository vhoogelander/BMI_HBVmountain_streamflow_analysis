...
class BMI_HBVmountain(Bmi):
    def __init__(self, forcing_netcdf=None, shapefile=None):
        self.model = build_HBVmountain_model()
        self.forcing_netcdf = forcing_netcdf

    def setup(self, forcing_netcdf=None, shapefile=None, Discharge=0.0, Total_Evaporation=0.0, Snow_Extend=np.zeros(1),
