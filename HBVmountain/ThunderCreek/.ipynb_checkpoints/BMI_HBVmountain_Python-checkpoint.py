...
class BMI_HBVmountain(Bmi):
    ...
    def setup(self, Discharge=0.0, Total_Evaporation=0.0, Snow_Extend=np.zeros(1), bare_storage=Storages(0, np.zeros(4), np.zeros(4), np.zeros(4), 0), forest_storage=Storages(0, np.zeros(4), np.zeros(4), np.zeros(4), 0), 
        grass_storage=Storages(0, np.zeros(4), np.zeros(4), np.zeros(4), 0), rip_storage=Storages(0, np.zeros(4), np.zeros(4), np.zeros(4), 0), Slowstorage=0.0, Waterbalance=0.0, Glacier=np.zeros(4), Area=0, Temp_Thresh=0.0, Meltfactor=3.0, Mm=0.01, Ratio_Pref=0.4, Kf=1.0, Ks=0.05, Ce=0.6, Soilstoragecapacity_Bare=40.0, beta_Bare1.0, Interceptioncapacity_Forest=7.0, Soilstoragecapacity_Forest=500.0, beta_Forest=1.0, Interceptioncapacity_Grass=3.0, Soilstoragecapacity_Grass=250.0, beta_Grass=1.0, Interceptioncapacity_Rip=4.0, Soilstoragecapacity_Rip=100.0, beta_Rip=1.0, Kf_Rip=1.3, Ratio_Riparian=0.1, Elevation=Elevations(0,500,100,250,250),Total_Elevationbands=4, Precipitation_gradient=0, Elevation_Percentage=[0.25,0.25,0.25,0.25],                   bare_input=HRU_Input([0,0,0,0], 0, np.zeros(4), [1,2,3,4], 4, (0,), (0,), 0, np.zeros(4), 0.01, np.zeros(4), 0, 0.0), 
        ...
        rip_parameters = Parameters(beta_Rip, Ce, Drainagecapacity, Interceptioncapacity_Rip, Kf_Rip, Meltfactor, Mm, Ratio_Pref, Soilstoaragecapacity_Rip, Temp_Thresh)
