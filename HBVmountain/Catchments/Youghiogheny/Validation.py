...
def run_validation(calibration_results):
    ...
    ########### Catchment dependent settings ######################
        ...
        area = 347.1 #km2 #Catchment dependent
        observation = pd.read_csv('Data/Youghiogheny/Discharge_Youghiogheny.csv', index_col=0).streamflow / (area * 1e6) * 1000 *86400 #Catchment dependent
