...
########### Catchment dependent settings ######################
    ...
    precipitation = precipitation.loc[precipitation.index.year <= 2005]
    model.finalize()
...
def full_calibration(ntimes):
    ...
    filename = 'cma_calibration_conasauga.yml' #Catchment dependent
    yaml = YAML()
...
def main():
    ...
    if rank == 0:
        ...
        name = 'paramsets_conasauga.csv' #Catchment dependent
        outdir = './output_conasauga' #Catchment dependent
